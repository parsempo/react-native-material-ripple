declare module 'react-native-material-ripple' {
    ...
    import { TouchableWithoutFeedbackProps, Animated, ViewProps } from 'react-native'
    ...
    export interface RippleProps extends TouchableWithoutFeedbackProps, ViewProps {
        ...
        onRippleAnimation?: (animation: Animated.TimingAnimationConfig, callback: () => void) => void
    }
